...
import { CheckCircle, XCircle, ArrowRight, Trophy, Bug } from "lucide-react";
...
export default function BugHunter({ questions, onComplete }: BugHunterProps) {
    ...
    return (
      <Card>
        <CardContent className="pt-6 text-center">
          ...
          <h2 className="text-2xl font-bold mb-2">Bug Hunt Complete!</h2>
          <p className="text-lg text-muted-foreground mb-4">
            Bugs Found: {score} / {questions.length}
          </p>
      ...
      <CardContent className="space-y-4">
        ...
        {showResult ? (
          <Button onClick={handleNext} className="w-full">
            {currentIndex === questions.length - 1 ? "Finish" : "Next Bug"}
